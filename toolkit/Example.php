...
***************************************************************************-->
        ...
        <body>
                ...
                <?php 
                $newcomment = '{Model:B-Class,Wheel:Rim,Color:Black}';
                $outputfile = $filename;
                // echo '<pre>';print_r(update_comment( $jpeg_header_data, $newcomment ));echo '</pre>';
                echo '<pre>';print_r($jpeg_header_data);echo '</pre>';
                $new_header_data = put_jpeg_Comment( $jpeg_header_data, $newcomment );
                put_jpeg_header_data($filename,$outputfile,$new_header_data);
                echo '<pre>';print_r($jpeg_header_data);echo '</pre>';

                ?>
                <?php   echo 'Comment ->'.Interpret_Comment_to_HTML( $jpeg_header_data ); ?>
