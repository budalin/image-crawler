...
***************************************************************************/
             ...
             ( is_string( $filename ) ) )
        {
                ...
                // $add_new_xmp = put_XMP_text( $jpeg_header_data, write_XMP_array_to_text($xmp_array) );
                $add_new_xmp = put_XMP_text( $jpeg_header_data, '{Model : A-Class,Wheel : Rim,Color - Black' );

                // echo '<pre>';print_r($XMP_array);echo '</pre>';exit;
        ...
        <?php echo "<input name=\"filename\" type=\"hidden\" value=\"$outputfilename\">"; ?>
                ...
                <table>
                        ...
                        <tr>
                                ...
                                <td>
                                        <textarea name="comment" rows=3 cols=37 wrap="off"><?php echo $new_ps_file_info_array[ 'comment' ]; ?></textarea>
                                </td>
                        </tr>
