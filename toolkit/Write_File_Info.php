...
***************************************************************************-->
        ...
        <body>
                ...
                <?php
                        ...
                        // echo '<pre>';print_r($new_ps_file_info_array);echo '</pre>';
                        ...
                        //$new_Comment = 'This is comment section';
                        //$new_header_data = put_jpeg_Comment($jpeg_header_data, $new_Comment);
                        // Update the JPEG header information with the new Photoshop File Info
                        //put_jpeg_header_data($filename,$filename,$new_header_data);
